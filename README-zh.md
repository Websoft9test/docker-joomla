...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Joomla 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://www.joomla.org/docs/user_guide/en/install-requirements.html)）：
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r joomla
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r joomla -p
```
2.复制package包后安装

将压缩的package包复制到想要安装的服务器或虚拟机，登录 Linux，运行下面的**自动化命令**即可启动安装并显示安装结果。
```
sudo bash install-joomla
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-joomla
cd docker-joomla
...
如果需要企业级支持，请订阅我们提供的 [Joomla 企业级支持版](https://apps.websoft9.com/joomla) 
